...
this.$vs.theme({
  primary:'rgb(211, 0, 29)' // my new color
})
        </prism>

        <p class="mt-5">By doing this, all <strong>The Key Society</strong> components in the application that use a primary color with change. Select one of the colors to change it and that all the components of this documentation have that color.</p>
